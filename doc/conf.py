...
copyright = '2022, QuTiP developers and contributors'
...
def _check_source_folder_and_imported_qutip_match():
    ...
    """
    import qutip_jax
    qutip_folder = pathlib.Path(qutip_jax.__file__).absolute().parent.parent
    ...
    if qutip_folder != source_folder:
        warnings.warn(
            ...
            " Qutip-jax package source: {!r}.".format(
...
html_title = 'QuTiP-Jax {} Documentation'.format(version)

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'QuTiP-Jax'
